...
const TIKTOK_URL = process.argv[2] || 'https://www.tiktok.com/@jasonmoments/video/7560870151021694230';
...
async function getDownloadLink(tiktokUrl) {
    try {
        ...
        if (videoLinks.size > 0) {
            ...
            console.log('\nNo video links found. The video might be private or deleted.');
            return [];
        }
