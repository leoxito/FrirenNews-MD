// Hecho por Ado :D - Versión modificada para módulo
...
// Función exportable - ÚNICO cambio
export async function getDownloadLink(IG_URL) {
  try {
    ...
    return { error: e?.message || String(e), detail }
  }
}